...
$1:
	...
	put_y_value(1, 1)
	put_constant('[]', 2)
	call_predicate('$process_option', 3, 22)
	put_structure(1, 0)
	set_constant('preprocess_only')
	set_y_value(21)
	put_y_value(1, 1)
	put_constant('false', 2)
	call_predicate('$process_option', 3, 21)
	put_structure(1, 0)
	...
	put_structure(1, 0)
	set_constant('compiler_object_trail')
	set_y_value(13)
	put_y_value(1, 1)
	put_integer(32, 2)
	call_predicate('$process_option', 3, 13)
	put_structure(1, 0)
	set_constant('compiler_ip_trail')
	set_y_value(12)
	put_y_value(1, 1)
	put_integer(32, 2)
...
$1:
	...
	put_integer(5, 0)
	put_constant('-S', 2)
	call_predicate('$get_boolean_opt_atom', 4, 20)
	put_y_value(19, 1)
	put_y_variable(17, 3)
	put_integer(6, 0)
	put_constant('-c', 2)
	call_predicate('$get_boolean_opt_atom', 4, 20)
	put_integer(7, 1)
	pseudo_instr3(1, 1, 39, 0)
	put_y_variable(16, 1)
	call_predicate('$fcompile_options_atom/2$0', 2, 20)
	put_y_value(19, 1)
	put_y_variable(15, 3)
	put_integer(8, 0)
	put_constant('-v', 2)
	...
	put_y_variable(14, 2)
	put_integer(9, 0)
	call_predicate('$get_number_opt_atom', 3, 20)
	put_y_value(19, 1)
	put_y_variable(13, 2)
	put_integer(10, 0)
	call_predicate('$get_number_opt_atom', 3, 20)
