...
$1:
	...
	deallocate
	proceed
end('$query_call1577577461_31/0$0'/0):



'$query_call1577577461_31'/0:
...
$1:
	allocate(0)
	call_predicate('$query_call1577577461_31/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_call1577577461_31'/0):
...
$1:
	execute_predicate('$query_call1577577461_31', 0)
end('$query'/0):
