...
// ##Copyright##
//
// $Id: machine.h,v 1.1.1.1 2000/12/07 21:48:04 qp Exp $
...
// @type machine_ip_address(IPAddress)
// @description
// Return the IP address of this machine.
// @end pred
// @end doc
ReturnValue psi_machine_ip_address(Object *&);
...
// @end pred
// @end doc
ReturnValue psi_machine_name(Object *&);
